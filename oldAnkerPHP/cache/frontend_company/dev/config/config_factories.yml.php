...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/sfprojects/ankerservices/trunk/log/frontend_company_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/sfprojects/ankerservices/trunk/cache/frontend_company/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/sfprojects/ankerservices/trunk/apps/frontend_company/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/sfprojects/ankerservices/trunk/cache/frontend_company/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/sfprojects/ankerservices/trunk/apps/frontend_company/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'aservicesmailer@googlemail.com',
      'password' => '0U9_QFF0Cim!zVB5',
    ),
  ),
))));
