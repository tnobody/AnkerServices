...
$response = $this->context->getResponse();
  ...
  $response->addStylesheet('ankerservicesPlugin/datepicker-fixed.css', '', array ());
  $response->addJavascript('date.js', '', array ());
  $response->addJavascript('date_de.js', '', array ());
  $response->addJavascript('jquery-1.6.4.min.js', '', array ());
  $response->addJavascript('jquery-ui-1.8.4.custom.min.js', '', array ());
  $response->addJavascript('jquery.ui.datepicker-de.js', '', array ());
  $response->addJavascript('jquery.datePicker.js', '', array ());
  $response->addJavascript('jquery.datePickerMultiMonth.js', '', array ());
