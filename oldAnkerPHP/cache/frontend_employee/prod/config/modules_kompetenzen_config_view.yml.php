...
$response = $this->context->getResponse();
  ...
  $response->addStylesheet('jqueryFormValidator/validationEngine.jquery.css', '', array ());
  $response->addJavascript('jquery-1.6.4.min.js', '', array ());
  $response->addJavascript('jquery-ui-1.8.4.custom.min.js', '', array ());
  $response->addJavascript('jquery.jstree.js', '', array ());
  $response->addJavascript('jqueryFormValidator/jquery.validationEngine.js', '', array ());
  $response->addJavascript('jqueryFormValidator/locales/jquery.validationEngine-de.js', '', array ());
