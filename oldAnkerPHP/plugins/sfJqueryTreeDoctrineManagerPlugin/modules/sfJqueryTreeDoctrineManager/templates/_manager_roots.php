				...
				<tr class="sf_admin_row <?php echo $odd ?>">
					...
					<td>
						<ul class="sf_admin_td_actions">
							<li class="sf_admin_action_edit"><?php echo link_to( __('Manage Tree') ,$sf_request->getParameter('module') . '/' . $sf_request->getParameter('action') . '?root=' . $root->kompetenz_kategorie_id);?></li>
						</ul>
					</td>
				</tr>
				<?php endforeach; ?>
